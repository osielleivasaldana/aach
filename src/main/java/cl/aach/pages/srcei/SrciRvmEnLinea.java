...
public class SrciRvmEnLinea {
    ...
    private static final By BUSCAR_BUTTON = By.id("masterContenido_btnBuscarSrcei");
    ...
    // Constructor
    // ==============================
    public SrciRvmEnLinea(WebDriver driver) {
        this.driver = driver;
    ...
    /**
     * Guarda la pestaña actual, hace clic en el botón consultor y en el modal, y cambia a la nueva pestaña.
     */
    ...
    /**
     * Cierra la pestaña actual y regresa a la pestaña original.
     */
