...
public class SisvfConsultaFecNacNombres {
    ...
    private static final By TIPO_DE_BUSQUEDA = By.id("Rbt_TipoDeBusqueda_1");
    private static final By FEC_NAC_INPUT = By.name("txtBusFecha");
    ...
    // Constructor
    // ==============================
    public SisvfConsultaFecNacNombres(WebDriver driver) {
        this.driver = driver;
    ...
    /**
     * Ingresa los datos de búsqueda (fecha de nacimiento, apellidos y nombres) y hace clic en buscar.
     *
     ...
     */
    public void enterData(String fecNac, String apPaterno, String apMaterno, String nombres) {
        driver.findElement(FEC_NAC_INPUT).sendKeys(fecNac);
